...
import logo from '../images/samuele.jpg';
...
export default function Sidebar() {
    ...
    const iconList = [
        {
            component: github,
            href: 'https://github.com/samuelemarino04?tab=repositories'
        },
        {
            component: linkedin,
            href: 'https://www.linkedin.com/in/samuele-marino-7baa9a27b/'
        },
        {
            component: gmail,
            href: 'samuele12601@gmail.com'
        }
    ];
    const item = {
